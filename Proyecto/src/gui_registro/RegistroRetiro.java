	...
	public RegistroRetiro() {
		...
		cboNumMatricula.addActionListener(new ActionListener() {
		    public void actionPerformed(ActionEvent e) {
		        // Verificar si estamos en modo eliminar (por ejemplo, si cboNumRetiro está habilitado)
	        ...
	        switch (accion) {
	            ...
	            case "CONSULTAR":
	                try {
	                    ...
	                    if (cur != null) txtCurso.setText(cur.getAsignatura());
